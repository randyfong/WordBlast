    ...
    <main className="min-h-screen bg-[#0f172a] text-slate-100 flex flex-col relative overflow-hidden py-6 px-4 md:px-8">
      ...
      <div className="max-w-7xl w-full mx-auto mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/librechat"
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-950/80 hover:bg-purple-900/80 text-purple-200 border border-purple-800 text-xs font-bold uppercase tracking-wider transition-all"
          >
            <Sparkles className="w-4 h-4 text-purple-400" />
            <span>LibreChat Analytics</span>
          </Link>
        </div>
